...
class CreateList(graphene.Mutation):
    ...
    def mutate(self, info, title):
        ...
        table.put_item(Item={'id': id, 'title': title, 'sort': 'newest', 'created': current_datetime, 'updated': current_datetime})
        return CreateList(list=ListModel(id, title, 'newest', current_datetime, current_datetime))
